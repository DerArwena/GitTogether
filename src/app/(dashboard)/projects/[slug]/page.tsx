...
import { Settings, Users, AlertCircle, ExternalLink } from "lucide-react";
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="flex gap-4 mt-2 text-xs text-muted-foreground">
            ...
            <span>{project._count.linkedRepos} repositories</span>
          </div>
        </div>
          ...
          <div className="space-y-1.5">
            {project.linkedRepos.map((repo) => (
              <a
                ...
                className="flex items-center gap-2 rounded-lg border border-border bg-background p-3 text-sm hover:border-foreground/20 transition-colors"
              >
